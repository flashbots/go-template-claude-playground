...
1. Create a feature branch (use descriptive branch names like `claude/issue-123-add-feature`)
2. Make the code changes
3. Commit the changes
4. Push the branch
5. Create the PR with `gh pr create --fill` or `gh pr create --title "..." --body "..."` and reference the issue number in the PR description (e.g., "Closes #123")
